...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL_QUERY_KEY = "URL_QUERY_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(URL_QUERY_KEY)) {
                String urlQuery = savedInstanceState.getString(URL_QUERY_KEY);
                mUrlDisplayTextView.setText(urlQuery);
            }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_QUERY_KEY, urlQuery);
